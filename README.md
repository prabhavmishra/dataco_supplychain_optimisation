...
Classified product categories into a "Risk-to-Reward" matrix.
...
dataco_cleaned.csv: The processed dataset used for visualization.
...
Run project.ipynb to clean the data and ingest it into your local PostgreSQL instance.

Execute dataco_supply_chain.sql to generate analytical views.

Open the Tableau workbook to view the interactive dashboard.
